...
function DriversStandingsSkeleton() {
  return (
...
export function DriversStandingsTable() {
  const { data, isPending, isError } = useDriverStandings()

  if (isPending) return <DriversStandingsSkeleton />
  if (isError) {
    return (
